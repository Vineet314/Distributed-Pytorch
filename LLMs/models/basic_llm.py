'''This script defines a simple LLM model.
The attention mechanisim, and eveything is the extreme basic version, implemetnted from scratch.
...
Train this using the basic_train.py
'''
import torch
